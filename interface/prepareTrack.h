...
// $Id: prepareTrack.h,v 1.2 2009/01/23 21:35:46 amraktad Exp $
//
...
namespace fireworks {
  ...
  public:
    ...
    {
      double product1 = state1.position.fX*m_direction.fX + state1.position.fY*m_direction.fY;
      double product2 = state2.position.fX*m_direction.fX + state2.position.fY*m_direction.fY;
